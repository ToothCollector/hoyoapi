...
test('parseCookie return should be valid', (t) => {
  ...
  t.deepEqual(
    cookie,
    'ltoken_v2=ltokenV2; ltuidV2=1; cookie_token=cookieToken; mi18nLang=id-id; cookie_token_v2=cookieTokenV2; account_id=1',
  )
})
...
test('parseCookieString return should be valid when account_id is null', (t) => {
  const cookieString = Cookie.parseCookieString(
    'ltoken_v2=ltokenV2; ltuidV2=1; cookie_token=cookieToken; cookie_token_v2=cookieTokenV2; mi18nLang=id-id',
  )
