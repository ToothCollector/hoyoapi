...
function generateDS() {
  ...
  const hash = createHash('md5')
    .update('salt='.concat(salt, '&t=').concat(time, '&r=').concat(random))
    .digest('hex')
...
var HTTPRequest = class {
  ...
  async send(url, method = 'GET', ttl = 60) {
    const fetch = (url2, method2) => {
      return new Promise((resolve, reject) => {
        ...
        Object.keys(this.params).forEach((val) => {
          ...
          queryParams.append(
            val,
            (_b = (_a = this.params[val]) == null ? void 0 : _a.toString()) !=
              null
              ? _b
              : '',
          )
                  ...
                  response: {
                    data:
                      (_a = response == null ? void 0 : response.data) != null
                        ...
                        : null,
                    message:
                      (_b = response == null ? void 0 : response.message) !=
                      null
                        ? _b
                        : '',
                    retcode:
                      (_c = response == null ? void 0 : response.retcode) !=
                      null
                        ? _c
                        : -1,
                  },
    ...
    const cacheKey = createHash2('md5')
      .update(
        JSON.stringify({
          url,
          method,
    ...
    if (
      [-1004, -2016, -500004, 429].includes(req.response.retcode) &&
      this.retries <= 120
    ) {
      this.retries++
      await delay(1)
...
var USER_GAMES_LIST = ''.concat(
  ACCOUNT_API,
  '/account/binding/api/getUserGameRolesByCookieToken',
)
var GAME_RECORD_CARD_API = ''.concat(
  BBS_API,
...
var getEventBaseUrl = (game) => {
  if (game === 'hk4e_global' /* GENSHIN_IMPACT */) {
    ...
    game === 'bh3_global' /* HONKAI_IMPACT */ ||
    game === 'hkrpg_global' /* HONKAI_STAR_RAIL */
  ) {
    return PUBLIC_API
  }
  return ''
...
var DAILY_INFO_API = (game) => {
  return ''
    .concat(getEventBaseUrl(game), '/event/')
    .concat(getEventName(game), '/info?act_id=')
    .concat(getActId(game))
}
var DAILY_REWARD_API = (game) => {
  return ''
    .concat(getEventBaseUrl(game), '/event/')
    .concat(getEventName(game), '/home?act_id=')
    .concat(getActId(game))
}
var DAILY_CLAIM_API = (game) => {
  return ''
    .concat(getEventBaseUrl(game), '/event/')
    .concat(getEventName(game), '/sign?act_id=')
    .concat(getActId(game))
}
var REDEEM_CLAIM_API = ''.concat(
  HK4E_API,
  '/common/apicdkey/api/webExchangeCdkey',
)
var GENSHIN_RECORD_INDEX_API = ''.concat(
  BBS_API,
  '/game_record/genshin/api/index',
)
var GENSHIN_RECORD_CHARACTER_API = ''.concat(
  BBS_API,
  '/game_record/genshin/api/character',
)
var GENSHIN_RECORD_AVATAR_BASIC_INFO_API = ''.concat(
  BBS_API,
  '/game_record/genshin/api/avatarBasicInfo',
)
var GENSHIN_RECORD_SPIRAL_ABYSS_API = ''.concat(
  BBS_API,
  '/game_record/genshin/api/spiralAbyss',
)
var GENSHIN_RECORD_DAILY_NOTE_API = ''.concat(
  BBS_API,
  '/game_record/genshin/api/dailyNote',
)
var GENSHIN_DIARY_LIST_API = ''.concat(HK4E_API, '/event/ysledgeros/month_info')
var GENSHIN_DIARY_DETAIL_API = ''.concat(
  HK4E_API,
  '/event/ysledgeros/month_detail',
)
var GENSHIN_TCG_BASICINFO = ''.concat(
  BBS_API,
  '/game_record/genshin/api/gcg/basicInfo',
)
var GENSHIN_TCG_CARDLIST = ''.concat(
  BBS_API,
  '/game_record/genshin/api/gcg/cardList',
)
var GENSHIN_TCG_MATCHLIST = ''.concat(
  BBS_API,
  '/game_record/genshin/api/gcg/matchList',
)
var GENSHIN_TCG_CHALLANGE_SCHEDULE = ''.concat(
  BBS_API,
  '/game_record/genshin/api/gcg/challenge/schedule',
)
var GENSHIN_TCG_CHALLANGE_RECORD = ''.concat(
  BBS_API,
  '/game_record/genshin/api/gcg/challenge/record',
)
var GENSHIN_TCG_CHALLANGE_DECK = ''.concat(
  BBS_API,
  '/game_record/genshin/api/gcg/challenge/deck',
)
var HSR_RECORD_CHARACTER_API = ''.concat(
  BBS_API,
  '/game_record/hkrpg/api/avatar/info',
)
...
var HSR_RECORD_FORGOTTEN_HALL_API = ''.concat(
  BBS_API,
  '/game_record/hkrpg/api/challenge',
)
var HI_RECORD_INDEX_API = ''.concat(BBS_API, '/game_record/honkai3rd/api/index')
var HI_RECORD_CHARACTER_API = ''.concat(
  BBS_API,
  '/game_record/honkai3rd/api/characters',
)
var HI_RECORD_ABYSS_API = ''.concat(
  BBS_API,
  '/game_record/honkai3rd/api/latestOldAbyssReport',
)
var HI_RECORD_ELYSIAN_API = ''.concat(
  BBS_API,
  '/game_record/honkai3rd/api/godWar',
)
var HI_RECORD_ARENA_API = ''.concat(
  BBS_API,
  '/game_record/honkai3rd/api/battleFieldReport',
)
